    ...
    <div className="space-y-6">
      ...
      <Dialog open={!!detailsObject} onOpenChange={open => !open && setDetailsObject(null)}><DialogContent className="max-w-3xl"><DialogHeader><DialogTitle>Object details</DialogTitle></DialogHeader>{detailsObject && <div className="space-y-4">
        ...
        <dl className="grid gap-3 text-sm sm:grid-cols-2">
          ...
          <div><dt className="text-xs text-muted-foreground">Size</dt><dd className="mt-1">{formatBytes(detailsObject.size)}</dd></div>
          <div><dt className="text-xs text-muted-foreground">Created</dt><dd className="mt-1">{formatDate(detailsObject.createdAt)}</dd></div>
          <div><dt className="text-xs text-muted-foreground">Updated</dt><dd className="mt-1">{formatDate(detailsObject.updatedAt)}</dd></div>
